...
import { getMelbourneImageUrls, getOkinawaImageUrls, getOsakaImageUrls, getPerthImageUrls, getSydneyImageUrls } from './utils/imageUtils';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/five" element={<Dest fileNames={getOkinawaImageUrls()}/>} />
      </Routes>
    </Router>
  );
};
